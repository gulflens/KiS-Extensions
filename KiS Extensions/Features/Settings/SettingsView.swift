        ...
        Form {
            Section {
                Button {
                    ...
                    HStack(spacing: 12) {
                        ProfileAvatar(name: settings.crewName,
                                      imageData: settings.profileImageData, size: 44)
                        VStack(alignment: .leading, spacing: 2) {
                            Text(settings.crewName.isEmpty ? "Set up your profile" : settings.crewName)
                                .font(.headline)
                                .foregroundStyle(.primary)
                            if !settings.rank.isEmpty {
                                Text(settings.rank)
                                    .font(.subheadline)
                ...
                Text("Your name is shown in the dashboard greeting and avatar.")
            }
